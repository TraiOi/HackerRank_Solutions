...
n = gets.chomp.to_i
dic = "C:CPP:JAVA:PYTHON:PERL:PHP:RUBY:CSHARP:HASKELL:CLOJURE:BASH:SCALA:ERLANG:CLISP:LUA:BRAINFUCK:JAVASCRIPT:GO:D:OCAML:R:PASCAL:SBCL:DART:GROOVY:OBJECTIVEC"
dic = dic.split(":")
dic = dic.join("|")
regex = /^\d+ (#{dic})$/
for i in (1..n)
